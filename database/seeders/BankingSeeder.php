...
class BankingSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Crypto currencies
        $cryptos = [
            ['code' => 'BTC', 'name' => 'Bitcoin', 'network' => 'Bitcoin', 'decimals' => 8, 'minimum_withdrawal' => 0.001, 'withdrawal_fee' => 0.0005, 'minimum_deposit' => 0.0001, 'deposit_fee' => 0, 'is_quote_currency' => true],
            ['code' => 'ETH', 'name' => 'Ethereum', 'network' => 'ERC20', 'decimals' => 18, 'minimum_withdrawal' => 0.01, 'withdrawal_fee' => 0.005, 'minimum_deposit' => 0.001, 'deposit_fee' => 0, 'is_quote_currency' => true],
            ['code' => 'USDT', 'name' => 'Tether', 'network' => 'ERC20', 'decimals' => 6, 'minimum_withdrawal' => 10, 'withdrawal_fee' => 1, 'minimum_deposit' => 1, 'deposit_fee' => 0, 'is_quote_currency' => true],
            ['code' => 'SOL', 'name' => 'Solana', 'network' => 'Solana', 'decimals' => 9, 'minimum_withdrawal' => 0.1, 'withdrawal_fee' => 0.01, 'minimum_deposit' => 0.01, 'deposit_fee' => 0],
            ['code' => 'XRP', 'name' => 'Ripple', 'network' => 'XRP Ledger', 'decimals' => 6, 'minimum_withdrawal' => 1, 'withdrawal_fee' => 0.1, 'minimum_deposit' => 0.1, 'deposit_fee' => 0],
        ];
