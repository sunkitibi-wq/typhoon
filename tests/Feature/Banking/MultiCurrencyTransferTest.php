...
class MultiCurrencyTransferTest extends TestCase
{
    ...
    public function test_coinmarketcap_exchange_rates_sync_command(): void
    {
        config(['services.exchange_rates.coinmarketcap_key' => 'test-key']);
        config(['services.exchange_rates.coinmarketcap_url' => 'https://pro-api.coinmarketcap.com']);

        // Create an active crypto currency
        ...
        $this->artisan('typhoon:update-exchange-rates --source=coinmarketcap --base=EUR')
            ->assertExitCode(0);
