...
export default function AdminKycReview() {
    const { props } = usePage();
    const { submissions, stats } = props as Props;
    ...
    return (
        <>
            <Head title="KYC Review Dashboard" />
            <div className="space-y-6 p-6">
                {/* Header */}
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">KYC Review Dashboard</h1>
...
AdminKycReview.layout = {
    breadcrumbs: [
        ...
        { title: 'KYC Review', href: '/admin/kyc' },
    ],
};
